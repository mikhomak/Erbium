...
public class CharacterAnimator : MonoBehaviour, ICharacterAnimator {
  ...
  private static readonly int GroundVelocity =
      Animator.StringToHash("groundVelocity");
  private static readonly int IsFalling = Animator.StringToHash("isFalling");
  private static readonly int IsAboutToLand =
      Animator.StringToHash("isAboutToLand");
  private static readonly int Crouching = Animator.StringToHash("crouching");
  private static readonly int Unskippable =
      Animator.StringToHash("unskippable");
  private static readonly int Sliding = Animator.StringToHash("sliding");
  private static readonly int StrongAttack =
      Animator.StringToHash("strongAttack");
  private static readonly int ComboAttack =
      Animator.StringToHash("comboAttack");
  ...
  public void SetSliding(bool sliding) { _animator.SetBool(Sliding, sliding); }

  public void TriggerStrongAttack() { _animator.SetTrigger(StrongAttack); }

  public void TriggerFastAttack() { _animator.SetTrigger(FastAttack); }

  public void SetComboAttack() { _animator.SetTrigger(ComboAttack); }

  public void ResetComboAttack() { _animator.ResetTrigger(ComboAttack); }

  public void ResetStrongAttack() { _animator.ResetTrigger(StrongAttack); }

  public void ResetFastAttack() { _animator.ResetTrigger(FastAttack); }
}
}
