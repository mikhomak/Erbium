...
namespace Characters.Movement {
  public class CrouchingMovement : AbstractMovement, IFallable, IJumpable {
    ...
    public override void SetUp() { animatorFacade.SetCrouching(true); }
    ...
    public override void Move(Vector3 direction) {
      ...
      AddVelocity(CommonMethods.CreateVectorWithoutLoosingYWithMultiplier(
          direction, rbd.velocity.y, stats.crouchSpeed));
      Rotate(direction);
    ...
    public override void CleanUp() { animatorFacade.SetCrouching(false); }
