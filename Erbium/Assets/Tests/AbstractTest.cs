...
public abstract class AbstractTest {
  ...
  protected static List<GameObject> Init() {
    List<GameObject> gameObjects = new List<GameObject>{
        Object.Instantiate(
            Resources.Load<GameObject>("Prefabs/Cameras/Main Camera")),
        Object.Instantiate(Resources.Load<GameObject>(
            "Prefabs/Cameras/Always Forward Camera")),
        Object.Instantiate(
            Resources.Load<GameObject>("Prefabs/Cameras/Camera Manager")),
        Object.Instantiate(
            Resources.Load<GameObject>("Prefabs/Enviroments/Test Floor")),
        Object.Instantiate(
            Resources.Load<GameObject>("Prefabs/General/Timer Manager"))};
    return gameObjects;
  }

  protected static GameObject InitInputManager() {
    return Object.Instantiate(
        Resources.Load<GameObject>("Prefabs/General/Input Manager"));
  }

  protected static GameObject InitPlayer(InputManager inputManager) {
    var playerGo =
        Object.Instantiate(Resources.Load<GameObject>("Prefabs/Player/Player"));
